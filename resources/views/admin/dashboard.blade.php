...
<div class="flex flex-col md:flex-row gap-8 justify-center mt-16">
    <a href="{{ route('clients.index') }}" class="group flex-1 min-w-[220px] bg-white/60 backdrop-blur border-4 border-transparent rounded-2xl shadow-md flex flex-col items-center py-8 hover:scale-105 transition-all relative"
    ...
    <a href="{{ route('puces.index') }}" class="group flex-1 min-w-[220px] bg-white/60 backdrop-blur border-4 border-transparent rounded-2xl shadow-md flex flex-col items-center py-8 hover:scale-105 transition-all relative"
        style="border-image: linear-gradient(90deg, #1BB4D8, #90E0EF) 1;"
    ...
    <a href="{{ route('kyc.index') }}" class="group flex-1 min-w-[220px] bg-white/60 backdrop-blur border-4 border-transparent rounded-2xl shadow-md flex flex-col items-center py-8 hover:scale-105 transition-all relative"
        style="border-image: linear-gradient(90deg, #1BB4D8, #90E0EF) 1;"
        title="Voir les KYC">
